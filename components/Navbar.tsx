...
//             <div className="text-[#005580] font-bold text-2xl">R4S</div>
//           </div>
//         </Link>
...
//           </Link>
//           {user ? (
//             // Show profile info and dashboard links if logged in
//             <>
...
//                   />
//                 )}
//                 <span className="text-[#005580] font-semibold">{user.name}</span>
//               </div>
